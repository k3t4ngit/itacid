...
<html lang="en">
  <head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo base_url(); ?>_assets/ico/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="<?php echo base_url(); ?>_assets/ico/apple-touch-icon-57-precomposed.png">
    <link rel="shortcut icon" href="<?php echo base_url(); ?>_assets/ico/favicon.png">
  </head>
  <body>
